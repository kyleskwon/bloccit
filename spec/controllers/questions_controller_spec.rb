...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of questions by 1" do
      expect{post :create, question: {title: RandomData.randon_question, body:RandomData.random_question, resolved: boolean}}.to
      change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, question: {title: RandomData.randon_question, body:RandomData.random_question, resolved: boolean}
  ...
  describe "PUT update" do
    it "updates question with expected attributes" do
      ...
      new_body = RandomData.random_question
